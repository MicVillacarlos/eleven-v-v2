...
const Settings = ({ initialRooms, initialTotal }: { initialRooms: HouseType[]; initialTotal: number })  => {
  ...
  //----- Start: table states ------
  const [roomDataTable, setRoomDataTable] = useState<HouseType[]>(initialRooms);
